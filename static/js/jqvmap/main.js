...
//         onLabelShow: function(event, label, code, mapData){
//
//             $.ajax({
//                 url : "/statistics/map/DetailsJSON/",
//                 //url : "/static/test/map.json",
//                 type : 'get',
//                 dataType: 'json',
//                 // traditional: true,
...
//                    // var  name = '<strong>'+label.text()+'</strong><br>';
//                     var  name = '<strong>'+mapData.paths[code].name+'</strong><br>';
//
//
//                     //var item= data_obj.filter(function (entry){return entry.code === code;});
//                     if(response.code!=null){
//                         label.html(name + 'Органов по сертификации: '+response.organ+'<br>'+ 'Испытательных лабораторий: '+response.il+'<br>'+ 'Cертифицированных объектов: '+response.public_cert);
//                     }
//                     else
//                     {
//                         label.html(name);
